...
namespace BlueGeeks.Data.Migrations
{
    ...
    [Migration("20191116231155_MatchesUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueGeeks.Models.Matches", b =>
                {
                    ...
                    b.Property<int?>("AwayTeamTeam_Id")
                        .HasColumnType("int");

                    b.Property<int>("AwayTeam_Id")
                        .HasColumnType("int");

                    b.Property<int?>("HomeTeamTeam_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AwayTeamTeam_Id");

                    b.HasIndex("HomeTeamTeam_Id");
            ...
            modelBuilder.Entity("BlueGeeks.Models.Matches", b =>
                {
                    b.HasOne("BlueGeeks.Models.Teams", "AwayTeam")
                        .WithMany()
                        .HasForeignKey("AwayTeamTeam_Id");

                    b.HasOne("BlueGeeks.Models.Teams", "HomeTeam")
                        .WithMany()
                        .HasForeignKey("HomeTeamTeam_Id");
